...
- **Domain events name facts in the past tense** — `OrderPlaced`, `PaymentCaptured`. They record
  what happened, carry IDs and values (not live object references), and let other contexts react.
...
- [ ] Domain events are named as past-tense facts and carry values, not live references
